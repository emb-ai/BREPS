...
COMMON="--print-ious --save-ious --datasets=FOR_TEST --n-clicks=1 --n_workers=1 --iou-analysis --thresh=0.5 --user_inputs --images_dir=$DATA/images --prompts_dir=$DATA/user_masks --masks_dir=$DATA/masks"
